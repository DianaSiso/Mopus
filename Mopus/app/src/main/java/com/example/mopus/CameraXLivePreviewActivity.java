...
import com.example.mopus.qrCodeScanner.CameraXViewModel;
import com.example.mopus.qrCodeScanner.GraphicOverlay;
import com.example.mopus.qrCodeScanner.VisionImageProcessor;
import com.example.mopus.qrCodeScanner.VisionProcessorBase;
  ...
  public class BarcodeScannerProcessor extends VisionProcessorBase<List<Barcode>> {
    ...
    protected void onSuccess(
      ...
      if (barcodes.isEmpty()) {
        ...
        Log.d(TAG, barcodes.get(0).getDisplayValue());
